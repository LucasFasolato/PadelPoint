  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "leagues" ADD COLUMN IF NOT EXISTS "avatarMediaAssetId" uuid`);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "leagues" DROP COLUMN IF EXISTS "avatarUrl"`);
    await queryRunner.query(
      `ALTER TABLE "leagues" DROP COLUMN IF EXISTS "avatarMediaAssetId"`,
    );
    await queryRunner.query(`ALTER TABLE "leagues" DROP COLUMN IF EXISTS "isPermanent"`);
    ...
    await queryRunner.query(`DROP TYPE IF EXISTS "match_audit_logs_action_enum_old"`);
  }
}
