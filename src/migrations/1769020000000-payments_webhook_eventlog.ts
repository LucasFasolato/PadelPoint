...
export class PaymentsWebhookEventLog1769020000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TYPE "public"."reservations_status_enum" ADD VALUE IF NOT EXISTS 'payment_pending'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."reservations_status_enum" ADD VALUE IF NOT EXISTS 'expired'`,
    );

    await queryRunner.query(
      `ALTER TYPE "public"."payment_intents_status_enum" ADD VALUE IF NOT EXISTS 'APPROVED'`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."payment_intents_status_enum" ADD VALUE IF NOT EXISTS 'FAILED'`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payment_intents_status_enum_old" AS ENUM('PENDING', 'REQUIRES_ACTION', 'SUCCEEDED', 'CANCELLED', 'EXPIRED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."reservations_status_enum_old" AS ENUM('hold', 'confirmed', 'cancelled')`,
    );
    await queryRunner.query(
