...
export class MatchResultsV11768305239849 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_d96b39b955cbb0730f1c4161de" ON "match_results" ("challengeId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "match_results" DROP CONSTRAINT "FK_49744d33ae1be851d1150bbefe8"`,
    );
    await queryRunner.query(
      `ALTER TABLE "match_results" DROP CONSTRAINT "FK_d96b39b955cbb0730f1c4161de7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d96b39b955cbb0730f1c4161de"`,
    );
    await queryRunner.query(`DROP TABLE "match_results"`);
    await queryRunner.query(`DROP TYPE "public"."match_results_status_enum"`);
    await queryRunner.query(
      `DROP TYPE "public"."match_results_winnerteam_enum"`,
    );
  }
}
